    ...
    return (
        ...
        <div className="overflow-hidden rounded-xl sm:rounded-2xl" ref={emblaRef}>
            ...
            {events.map((item, index) => (
                <div
                key={index}
                className="relative flex-[0_0_100%] sm:flex-[0_0_100%] md:flex-[0_0_50%] lg:flex-[0_0_50%] p-3 sm:p-4"
                >
                <div className="p-5 sm:p-6 bg-white rounded-lg shadow-md h-full transition-transform duration-300 hover:scale-[1.02]">
