...
export const staysData: Stay[] = [
    ...
    aboutProperty: "Jetwing Jaffna in Jaffna offers air-conditioned rooms with balconies, private bathrooms, and modern amenities. Each room includes a work desk, minibar, and free WiFi, ensuring a pleasant stay. The hotel features a family-friendly restaurant serving Indian cuisine with halal options. Guests can relax on the sun terrace or enjoy the bar, which offers a variety of beverages. Additional facilities include a lounge, outdoor seating area, and free on-site private parking. Located 16 km from Jaffna International Airport, the hotel is close to attractions such as Jaffna Fort (less than 1 km) and Jaffna Public Library (6-minute walk). Nearby points of interest include Nallur Kandaswamy Temple (2 km) and Naguleswaram Temple (20 km). Highly rated by guests for its attentive staff and excellent service support, the hotel also receives praise for its bar and convenient location.",
    address: "37 Mahatma Gandhi Road, Jaffna",
    images: ["jetwing1.jpg", "jetwing2.jpg", "jetwing3.jpg", "jetwing4.jpg", "jetwing5.jpg", "jetwing6.jpg", "jetwing7.jpg", "jetwing8.jpg", "jetwing9.jpg", "jetwing10.jpg", "jetwing11.jpg", "jetwing12.jpg", "jetwing13.jpg", "jetwing14.jpg", "jetwing15.jpg"],
    amenities: [
    ...
    aboutProperty: "Fox Jaffna in Jaffna offers family rooms with air-conditioning, private bathrooms, and garden views. Each room includes a tea and coffee maker, refrigerator, and free toiletries. Guests enjoy spa facilities, a swimming pool with a view, sun terrace, and lush garden. The resort provides free WiFi, a fitness centre, and a lounge. Dining Experience: The family-friendly restaurant serves Chinese, British, French, Indian, and local cuisines. Breakfast options include continental, American, and full English. Prime Location: Located 11 km from Jaffna International Airport, the resort is near attractions such as Nallur Kandaswamy Temple (4.4 km) and Jaffna Fort (5 km). Free on-site parking is available.", 
    address: "No 257, K.K.S Road Kokuvil, Jaffna",
    images: ["fox1.jpg", "fox2.jpg", "fox3.jpg", "fox4.jpg", "fox5.jpg", "fox6.jpg", "fox7.jpg", "fox8.jpg", "fox9.jpg", "fox10.jpg", "fox11.jpg", "fox12.jpg", "fox13.jpg", "fox14.jpg"],
    amenities: [
        { icon: "spa", amenity: "Spa" },
        { icon: "wifi", amenity: "Free Wi-Fi" },
        { icon: "utensils", amenity: "Restaurant" },
    ...
    images: ["greengrass1.jpg", "greengrass2.jpg", "greengrass2.jpg", "greengrass4.jpg", "greengrass5.jpg", "greengrass6.jpg", "greengrass7.jpg", "greengrass8.jpg", "greengrass9.jpg", "greengrass10.jpg", "greengrass11.jpg", "greengrass12.jpg"],
    amenities: [
        { icon: "wifi", amenity: "Free Wi-Fi" },
        { icon: "utensils", amenity: "Restaurant" },
        { icon: "car", amenity: "Parking" },
    ...
    aboutProperty: "Thambu Illam in Jaffna offers family rooms with air-conditioning, private bathrooms, and garden views. Each room includes a tea and coffee maker, bidet, and free toiletries. Guests enjoy a swimming pool with a view, outdoor dining area, and free WiFi. Additional amenities include a restaurant, garden, and outdoor furniture. Located 14 km from Jaffna International Airport, the hotel is near Nallur Kandaswamy Temple (2 km) and Jaffna Railway Station (2 km). Other attractions include Jaffna Fort (3 km) and Naguleswaram Temple (18 km). Highly rated for its swimming pool, attentive staff, and breakfast provided by the property.",
    address: "107 Brown Road, Jaffna",
    images: ["thambu1.jpg", "thambu2.jpg", "thambu3.jpg", "thambu4.jpg", "thambu5.jpg", "thambu6.jpg", "thambu7.jpg", "thambu8.jpg", "thambu9.jpg", "thambu10.jpg", "thambu11.jpg", "thambu12.jpg"],
    amenities: [
        { icon: "wifi", amenity: "Free Wi-Fi" },
        { icon: "utensils", amenity: "Restaurant" },
        { icon: "car", amenity: "Parking" },
    ...
    images: ["pj1.jpg", "pj2.jpg", "pj3.jpg", "pj4.jpg", "pj5.jpg", "pj6.jpg", "pj7.jpg", "pj8.jpg", "pj9.jpg", "pj10.jpg", "pj11.jpg", "pj12.jpg", "pj13.jpg", "pj14.jpg"],
    amenities: [
        { icon: "spa", amenity: "Spa" },
        { icon: "wifi", amenity: "Free Wi-Fi" },
        { icon: "utensils", amenity: "Restaurant" },
